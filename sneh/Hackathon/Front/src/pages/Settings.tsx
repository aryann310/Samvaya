      ...
      <div className="max-w-3xl space-y-6">
        <div className="bg-[#1B2028] border border-[#323A46] p-6 rounded-2xl shadow-xl">
          ...
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <button className="px-5 py-2.5 rounded-xl bg-[#38BDF8] text-[#0B0C0F] font-bold text-sm shadow-[0_0_12px_rgba(56,189,248,0.3)] hover:bg-[#0284C7] transition-all">
        ...
        <div className="bg-[#1B2028] border border-[#323A46] p-6 rounded-2xl shadow-xl">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <button 
              ...
              className={`p-3.5 rounded-xl border text-center transition-all ${i18n.language.startsWith('en') ? 'border-[#38BDF8] bg-[#38BDF8]/10 text-[#38BDF8] font-bold shadow-[0_0_12px_rgba(56,189,248,0.2)]' : 'border-[#323A46] bg-[#11141A] text-[#7E8A99] hover:border-[#7E8A99]'}`}
            >
            ...
            <button 
              ...
              className={`p-3.5 rounded-xl border text-center transition-all ${i18n.language.startsWith('hi') ? 'border-[#38BDF8] bg-[#38BDF8]/10 text-[#38BDF8] font-bold shadow-[0_0_12px_rgba(56,189,248,0.2)]' : 'border-[#323A46] bg-[#11141A] text-[#7E8A99] hover:border-[#7E8A99]'}`}
            >
            ...
            <button 
              ...
              className={`p-3.5 rounded-xl border text-center transition-all ${i18n.language.startsWith('gu') ? 'border-[#38BDF8] bg-[#38BDF8]/10 text-[#38BDF8] font-bold shadow-[0_0_12px_rgba(56,189,248,0.2)]' : 'border-[#323A46] bg-[#11141A] text-[#7E8A99] hover:border-[#7E8A99]'}`}
            >
